...
const FEATURES_ENTERPRISE = [
  "Agents illimités & sur-mesure",
  "LLM local hébergé chez vous",
  "Intégrations API avancées",
  "SLA & support prioritaire dédié",
  "Formation équipe incluse",
  "Accompagnement continu mensuel",
] as const;
          ...
          >
            ...
            <div className="text-center">
              <div className="flex items-end justify-center gap-1">
                <span className="text-6xl font-bold text-foreground">208</span>
              ...
              <p className="mx-auto mt-3 max-w-sm text-sm leading-relaxed text-muted-foreground">
                Vos agents travaillent pour vous 24h/24 — prospection, suivi, 
                automatisation. Un investissement qui se rembourse dès le premier lead converti.
              </p>
            </div>
            ...
            <div className="mt-10 text-center">
              ...
              <p className="mt-4 text-xs text-muted-foreground text-balance">
                Sans engagement. Audit gratuit inclus. Déployé en moins de 7 jours.
              </p>
            </div>
          </div>
          ...
          <div className="relative overflow-hidden rounded-3xl border border-orange-500/20 bg-orange-500/5 p-8 lg:col-span-1 flex flex-col">
            ...
            <div className="mt-8 text-center">
              ...
              <p className="mt-1.5 text-xs text-muted-foreground">
                Adapté à vos volumes & contraintes
              </p>
            </div>

            {/* Description */}
            <p className="mt-4 text-center text-xs leading-relaxed text-muted-foreground">
              Besoin d'agents illimités, d'un LLM hébergé chez vous ou d'intégrations avancées ? On construit la solution exacte dont vous avez besoin.
            </p>
