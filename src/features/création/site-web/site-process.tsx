...
const STEPS: Step[] = [
  {
    ...
    description:
      "Échange approfondi pour comprendre vos activités, vos objectifs, votre cible et définir les fonctionnalités indispensables de votre site web.",
  },
  {
    number: "02",
    icon: Paintbrush,
    ...
    description:
      "Création du design graphique sur mesure, validation des visuels, de la navigation et de l'expérience utilisateur avant tout développement.",
  },
  {
    number: "03",
    icon: Code2,
    ...
    description:
      "Intégration technique, performances optimisées, référencement et des formulaires. Tests sur tous les navigateurs et appareils.",
  },
  {
    number: "04",
    icon: Rocket,
    ...
    description:
      "Déploiement du site, configuration des outils de suivi, formation à la gestion et accompagnement post-lancement.",
  },
];
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-lg text-muted-foreground text-pretty">
            Un processus structuré en 4 étapes pour livrer un site
            professionnel qui répond exactement à vos besoins.
          </p>
        </div>
