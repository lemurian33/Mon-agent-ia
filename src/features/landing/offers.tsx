...
const OFFERS: Offer[] = [
  ...
  },
  {
    ...
    priceUnit: "par mois",
    description:
      "Écosystème I.A. complet, souverain et conforme RGPD. Hébergement, automatisation et LLM open source pour créer votre équipe d'agents.",
    features: [
      "Hébergement Coolify inclus",
      "Automatisation n8n + RAG",
      "Claude ou LLM open source",
      "stockage vectoriel",
  ...
  //   priceUnit: "par mois",
  //   description:
  //     "Un agent vocal I.A. répond à vos appels entrants 24h/24, qualifie vos prospects et prend des rendez-vous — sans secrétaire, sans raté.",
  //   features: [
